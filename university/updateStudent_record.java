...
//        p1.add(t10);
    ...
    void trial(String sm)
    {
        try
        {
            ...
            String qq="select * from new_student_add where roll_no='"+sm+"'";
    ...
    public void actionPerformed(ActionEvent ev)
    {
        if(ev.getSource()==bt1)
        {
            ...
            {
                connection obj=new connection();
                String q="update new_student_add set name='"+name+"',father_name='"+father_name+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',class_X='"+classX+"',class_XII='"+classXII+"',branch='"+branch+"',cource='"+cource+"' where roll_no='"+rollno+"'";
