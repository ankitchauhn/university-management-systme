...
import java.awt.*;
import javax.swing.*;
public class teacher_attendunce extends JFrame implements ActionListener
{
    JLabel l1,l2,l3;
    Choice c1,c2,c3;
    JButton bt1,bt2;
    ...
    teacher_attendunce()
    {
            ...
            l1=new JLabel("Select Employment Id");
    ...
    public void actionPerformed(ActionEvent ev)
    {
        if(ev.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q1="insert into teacher_attendencec values('"+ch_employ+"','"+ch_first_half+"','"+ch_second_half+"','"+dt+"')";
