...
import java.awt.*;
import javax.swing.*;
public class new_student_addmission extends JFrame implements ActionListener
{
    ...
    new_student_addmission()
    {
       ...
       // l10.setFont(f1);
        ...
        ImageIcon ii1=new ImageIcon(ClassLoader.getSystemResource("university/icons/men1.png"));
...
//                String q1="select * from new_student_add";
//                ResultSet rset=obj.stm.executeQuery(q1);
//                while(rset.next())
//                {
//                    String rr=rset.getString("roll_no");
//                    if(rr.equals(rollno))
//                    {
//                        JOptionPane.showMessageDialog(null,"this no is already register");
//                        setVisible(false);
//                        this.setVisible(true);
//                    }
//                    else
//                    {
                        String q="insert into new_student_add values('"+rollno+"','"+name+"','"+father_name+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+classX+"','"+classXII+"','"+branch+"','"+cource+"')";
